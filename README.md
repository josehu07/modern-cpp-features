...
* Added runnable examples under `runnable/` to show how the features behave in action; building them requires GNU GCC of [sufficiently up-to-date version](https://gcc.gnu.org/projects/cxx-status.html) that covers C++20 standard support:
  ```bash
  cd runnable
  make clean && make
  make run-all
